      ...
      <div className="flex flex-col lg:flex-row items-center justify-evenly lg:justify-around pb-[70px] lg:py-[80px] xl:justify-evenly">
        <div className="mt-16 lg:mt-0 md:w-[500px] lg:w-[550px]">
          ...
          <p className="text-lightBlack pb-1 leading-[1.6] text-center lg:text-start px-5 lg:px-0 lg:w-[80%]">
            Hello, my name is Mittal, a passionate developer committed to
        ...
        <div className="border-[5px] mt-10 lg:mt-0 border-darkBlack rounded-full p-[4px]">
          <div
            onMouseEnter={() => setIsHovering(true)}
            onMouseLeave={() => setIsHovering(false)}
            className="h-[250px] w-[250px] xl:h-[350px] xl:w-[350px] rounded-full flex items-center justify-center border-[2px] border-darkBlack shadow-lighShadow overflow-hidden"
          >
            <div className="relative flex scale-110 justify-center bg-[#0fcfc4] items-center rounded-full h-full w-full">
              <img
                className={`h-full w-full rounded-full absolute shadow-darkShadow ${
              ...
              />
              <img
                className={`h-full w-full rounded-full absolute shadow-darkShadow z-0`}
                src={hoveredMe}
                alt=""
              />
            </div>
